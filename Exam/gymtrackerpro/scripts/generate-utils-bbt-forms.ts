...
const escapeLikeBbt: BbtDescriptor = {
    ...
    epTcRows: [
        ...
        {noTc: 7, ec: '7', inputData: '"%%"', expected: '"\\%\\%"'},
        {noTc: 8, ec: '8', inputData: '"__"', expected: '"\\_\\_"'},
        {noTc: 9, ec: '9', inputData: '"\\\\"', expected: '"\\\\\\\\"'},
    ],
    bvaRows: [
    ...
    finalTcRows: [
        {noTc: 1, fromEc: 'EC-1', fromBva: '', inputData: '"benchpress" (plain string)', expected: '"benchpress"'},
        {noTc: 2, fromEc: 'EC-2', fromBva: '', inputData: '"100%" (percent)', expected: '"100\\%"'},
        {noTc: 3, fromEc: 'EC-3', fromBva: '', inputData: '"bench_press" (underscore)', expected: '"bench\\_press"'},
        {noTc: 4, fromEc: 'EC-4', fromBva: '', inputData: '"path\\value" (backslash)', expected: '"path\\\\value"'},
        {noTc: 5, fromEc: 'EC-5', fromBva: '', inputData: '"100%_bench\\press" (mixed)', expected: '"100\\%\\_bench\\\\press"'},
        {noTc: 6, fromEc: 'EC-6', fromBva: 'BVA-1', inputData: '"" (empty, n=0)', expected: '""'},
        {noTc: 7, fromEc: 'EC-7', fromBva: 'BVA-3', inputData: '"%%"  (consecutive %, n=2)', expected: '"\\%\\%"'},
        {noTc: 8, fromEc: 'EC-8', fromBva: 'BVA-3', inputData: '"__"  (consecutive _, n=2)', expected: '"\\_\\_"'},
        {noTc: 9, fromEc: 'EC-9', fromBva: 'BVA-3', inputData: '"\\\\" (consecutive \\, n=2)', expected: '"\\\\\\\\"'},
        {noTc: 10, fromEc: '', fromBva: 'BVA-2', inputData: '"a"   (plain char, n=1)', expected: '"a"'},
        {noTc: 11, fromEc: '', fromBva: 'BVA-2', inputData: '"%" (single %, n=1)', expected: '"\\%"'},
        {noTc: 12, fromEc: '', fromBva: 'BVA-2', inputData: '"_"  (single _, n=1)', expected: '"\\_"'},
        {noTc: 13, fromEc: '', fromBva: 'BVA-2', inputData: '"\\". (single \\, n=1)', expected: '"\\\\"'},
        {noTc: 14, fromEc: '', fromBva: 'BVA-3', inputData: '"ab"  (plain chars, n=2)', expected: '"ab"'},
    ],
};
