...
const exerciseControllerCreateExerciseIt: ItDescriptor = {
  ...
  action     -> AppError      [label="catches (conflict)", style=dashed];
    ...
    tcRows: [
        ...
        {
            noTc: '4',
            arrange: 'Empty database.\nconst firstInput: CreateExerciseInput = { name: "Squat", description: "Leg compound", muscleGroup: MuscleGroup.LEGS, equipmentNeeded: Equipment.BARBELL }\nconst secondInput: CreateExerciseInput = { name: "Leg Press", description: "Quad focused", muscleGroup: MuscleGroup.LEGS, equipmentNeeded: Equipment.MACHINE }',
            act: 'createExercise(firstInput) then createExercise(secondInput)',
            expectedReturn: 'Both calls return { success: true, data: Exercise } with distinct ids',
            expectedDbState: 'Two rows in exercises table; ids are distinct',
            actualResult: 'Not yet run',
        },
    ],
};
...
const exerciseControllerListExercisesIt: ItDescriptor = {
  ...
  action      -> AppError     [label="catches", style=dashed];
    ...
    tcRows: [
        {
            noTc: '1',
            arrange: 'Seeded via exerciseService.create(): Squat (LEGS, active), Bench Press (CHEST, active). Leg Press seeded then archived via exerciseService.archiveExercise().',
            act: 'listExercises()',
        ...
        {
            noTc: '4',
            arrange: 'Seeded via exerciseService.create(): Bench Press (CHEST, active). Leg Press seeded then archived via exerciseService.archiveExercise().\nconst options: ExerciseListOptions = { includeInactive: true }',
            act: 'listExercises(options)',
            expectedReturn: '{ success: true, data: { total: 2, items: [Bench Press, Leg Press] } } — at least one item has isActive = false',
            expectedDbState: 'No change',
            actualResult: 'Not yet run',
        },
        {
            noTc: '5',
            arrange: 'Seeded via exerciseService.create(): Bench Press (CHEST), Deadlift (BACK), Cable Row (BACK).\nconst options: ExerciseListOptions = { muscleGroup: MuscleGroup.BACK }',
            act: 'listExercises(options)',
            expectedReturn: '{ success: true, data: { total: 2, items: all have muscleGroup = BACK } }',
            expectedDbState: 'No change',
            actualResult: 'Not yet run',
        },
        {
            noTc: '6',
            arrange: 'Seeded via exerciseService.create(): Bench Press (CHEST, BARBELL), Incline Press (CHEST, DUMBBELL), Deadlift (BACK, BARBELL).\nconst options: ExerciseListOptions = { search: "PRESS" }',
            act: 'listExercises(options)',
            expectedReturn: '{ success: true, data: { total: 2, items: all have name containing "press" (case-insensitive) } }',
            expectedDbState: 'No change',
            actualResult: 'Not yet run',
        },
        {
            noTc: '7',
            arrange: 'Seeded via exerciseService.create(): Bench Press (CHEST, BARBELL), Incline Press (CHEST, DUMBBELL), Shoulder Press (SHOULDERS, BARBELL).\nconst options: ExerciseListOptions = { search: "press", muscleGroup: MuscleGroup.CHEST }',
            act: 'listExercises(options)',
            expectedReturn: '{ success: true, data: { total: 2, items: all have muscleGroup = CHEST and name containing "press" } }',
            expectedDbState: 'No change',
            actualResult: 'Not yet run',
        },
        {
            noTc: '8',
            arrange: 'Seeded via exerciseService.create(): Exercise A (CHEST), Exercise B (CHEST), Exercise C (CHEST).\nconst firstOptions: ExerciseListOptions = { page: 1, pageSize: 2 }\nconst secondOptions: ExerciseListOptions = { page: 2, pageSize: 2 }',
            act: 'listExercises(firstOptions) then listExercises(secondOptions)',
            expectedReturn: 'First call: { success: true, data: { total: 3, items: [2 items] } }. Second call: { success: true, data: { total: 3, items: [1 item] } }. No id appears in both pages.',
            expectedDbState: 'No change',
            actualResult: 'Not yet run',
        },
        {
            noTc: '9',
            arrange: 'Seeded via exerciseService.create(): Bench Press (CHEST, BARBELL, active), Incline Press (CHEST, DUMBBELL) then archived, Deadlift (BACK, BARBELL, active).\nconst options: ExerciseListOptions = { includeInactive: true, search: "press" }',
            act: 'listExercises(options)',
            expectedReturn: '{ success: true, data: { total: 2, items: all have name containing "press", at least one has isActive = false } }',
            expectedDbState: 'No change',
            actualResult: 'Not yet run',
        },
        {
            noTc: '10',
            arrange: 'Seeded via exerciseService.create(): Squat (LEGS, BARBELL), Bench Press (CHEST, BARBELL).\nconst options: ExerciseListOptions = { page: 1, pageSize: 100 }',
            act: 'listExercises(options)',
            expectedReturn: '{ success: true, data: { total: 2, items: [2 items] } }',
            expectedDbState: 'No change',
            actualResult: 'Not yet run',
        },
        {
            noTc: '11',
            arrange: 'Seeded via exerciseService.create(): Bench Press (CHEST, BARBELL), Deadlift (BACK, BARBELL).\nconst options: ExerciseListOptions = { search: "Bench%" }',
            act: 'listExercises(options)',
            expectedReturn: '{ success: true, data: { items: [], total: 0 } } — "%" is treated as a literal character, not a SQL wildcard',
            expectedDbState: 'No change',
            actualResult: 'Not yet run',
        },
    ],
...
const exerciseControllerUpdateExerciseIt: ItDescriptor = {
  ...
  action     -> AppError      [label="catches", style=dashed];
    ...
    tcRows: [
        ...
        {
            noTc: '2',
            arrange: 'Exercise "Squat" (LEGS, BARBELL, description: "Original description") seeded via exerciseService.create().\nconst data: UpdateExerciseInput = { name: "Barbell Back Squat" }',
            act: 'updateExercise(seededExercise.id, data)',
            expectedReturn: '{ success: true, data: { name: "Barbell Back Squat" } }',
            expectedDbState: 'Row name updated; description = "Original description", muscleGroup = LEGS, equipmentNeeded = BARBELL all unchanged',
            actualResult: 'Not yet run',
        },
        {
            noTc: '3',
        ...
        },
        {
            ...
            act: 'updateExercise(seededExercise.id, data)',
            expectedReturn: '{ success: true, data: { name: "Squat", description: "Original description", muscleGroup: LEGS, equipmentNeeded: BARBELL } }',
...
const createMemberIt: ItDescriptor = {
  ...
  action     -> AppError      [label="catches (conflict)", style=dashed];
    ...
    tcRows: [
        ...
        {
            noTc: '4',
            arrange: 'Member "alice@gym.test" seeded via userService.createMember() (TC2 conflict scenario already resolved).\nconst input: CreateMemberInput = { email: "bob@gym.test", fullName: "Bob Jones", phone: "+40700000002", dateOfBirth: "1992-08-10", password: "ValidPass123!", membershipStart: "2024-01-01" }',
            act: 'createMember(input)',
            expectedReturn: '{ success: true, data: { id: defined, isActive: true, user: { email: "bob@gym.test", role: "MEMBER" } } }',
            expectedDbState: 'Two member rows present; alice row unchanged',
            actualResult: 'Passed',
        },
    ],
};
...
const createAdminIt: ItDescriptor = {
  ...
  action     -> AppError      [label="catches (conflict)", style=dashed];
    ...
    tcRows: [
        ...
        {
            noTc: '4',
            arrange: 'Admin "admin@gym.test" seeded via userService.createAdmin() (TC2 conflict scenario already resolved).\nconst input: CreateAdminInput = { email: "admin2@gym.test", fullName: "Admin Two", phone: "+40700000011", dateOfBirth: "1987-04-15", password: "AdminPass123!" }',
            act: 'createAdmin(input)',
            expectedReturn: '{ success: true, data: { id: defined, user: { email: "admin2@gym.test", role: "ADMIN" } } }',
            expectedDbState: 'Two admin rows present; first admin row unchanged',
            actualResult: 'Passed',
        },
    ],
};
...
const listMembersIt: ItDescriptor = {
  ...
  action      -> AppError    [label="catches", style=dashed];
    ...
    tcRows: [
        ...
        {
            noTc: '4',
            arrange: 'Seeded via userService.createMember(): Alice Smith (alice@gym.test), Bob Johnson (bob@gym.test).\nconst options: MemberListOptions = { search: "alice@gym.test" }',
            act: 'listMembers(options)',
            expectedReturn: '{ success: true, data: { total: 1, items: [{ user: { email: "alice@gym.test" } }] } }',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        },
        {
            noTc: '5',
            arrange: 'Seeded via userService.createMember(): Alice Smith (alice@gym.test), Bob Johnson (bob@gym.test).\nconst options: MemberListOptions = { page: 1, pageSize: 100 }',
            act: 'listMembers(options)',
            expectedReturn: '{ success: true, data: { total: 2, items: array of length 2 } }',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        },
        {
            noTc: '6',
            arrange: 'Seeded via userService.createMember(): Alice Smith (alice@gym.test).\nconst options: MemberListOptions = { search: "%" }',
            act: 'listMembers(options)',
            expectedReturn: '{ success: true, data: { total: 0, items: [] } }',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        },
        {
            noTc: '7',
            arrange: 'Seeded via userService.createMember(): Alice Smith (alice@gym.test), Bob Johnson (bob@gym.test), Charlie Brown (charlie@gym.test) — unique phones.\nconst optionsP1: MemberListOptions = { page: 1, pageSize: 2 }\nconst optionsP2: MemberListOptions = { page: 2, pageSize: 2 }',
            act: 'listMembers(optionsP1) then listMembers(optionsP2)',
            expectedReturn: 'Page 1: { success: true, data: { total: 3, items: array of length 2 } }\nPage 2: { success: true, data: { total: 3, items: array of length 1 } }\nNo id appears in both pages',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        },
    ],
  ...
  action     -> AppError   [label="catches", style=dashed];
    ...
    tcRows: [
        ...
        },
        {
            ...
            act: 'listAdmins(options)',
            expectedReturn: '{ success: true, data: { total: 1, items: [{ user: { fullName: "Alice Admin" } }] } }',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        },
        {
            noTc: '5',
            arrange: 'Seeded via userService.createAdmin(): Alice Admin (alice-a@gym.test), Bobby Admin (bob-a@gym.test).\nconst options: AdminListOptions = { page: 1, pageSize: 100 }',
            act: 'listAdmins(options)',
            expectedReturn: '{ success: true, data: { total: 2, items: array of length 2 } }',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        ...
        {
            noTc: '6',
            arrange: 'Seeded via userService.createAdmin(): Alice Admin (alice-a@gym.test).\nconst options: AdminListOptions = { search: "%" }',
            act: 'listAdmins(options)',
            expectedReturn: '{ success: true, data: { total: 0, items: [] } }',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        ...
        {
            noTc: '7',
            arrange: 'Seeded via userService.createAdmin(): Alice Admin (alice-a@gym.test), Bobby Admin (bob-a@gym.test), Charlie Admin (charlie-a@gym.test) — unique phones.\nconst optionsP1: AdminListOptions = { page: 1, pageSize: 2 }\nconst optionsP2: AdminListOptions = { page: 2, pageSize: 2 }',
            act: 'listAdmins(optionsP1) then listAdmins(optionsP2)',
            expectedReturn: 'Page 1: { success: true, data: { total: 3, items: array of length 2 } }\nPage 2: { success: true, data: { total: 3, items: array of length 1 } }\nNo id appears in both pages',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        },
...
const updateMemberIt: ItDescriptor = {
  ...
  action     -> AppError      [label="catches", style=dashed];
    ...
    tcRows: [
        ...
        {
            noTc: '7',
            arrange: 'Member "alice@gym.test" (fullName: "Alice Smith") seeded via userService.createMember().\nconst data: UpdateMemberInput = { email: "alice@gym.test", fullName: "Alice Renamed" }',
            act: 'updateMember(seeded.id, data)',
            expectedReturn: '{ success: true, data: { user: { email: "alice@gym.test", fullName: "Alice Renamed" } } }',
            expectedDbState: 'fullName updated; email unchanged',
            actualResult: 'Passed',
        },
        {
            noTc: '8',
            arrange: 'Seeded via userService.createMember(): alice (alice@gym.test), bob (bob@gym.test).\nFirst call: updateMember(alice.id, { email: "bob@gym.test" }) → ConflictError.\nconst data: UpdateMemberInput = { email: "charlie@gym.test", fullName: "Alice Charlie" }',
            act: 'updateMember(alice.id, data)',
            expectedReturn: '{ success: true, data: { user: { email: "charlie@gym.test", fullName: "Alice Charlie" } } }',
            expectedDbState: 'alice row updated to charlie@gym.test; bob row unchanged',
            actualResult: 'Passed',
        },
    ],
};
...
const updateAdminIt: ItDescriptor = {
  ...
  action     -> AppError      [label="catches", style=dashed];
    ...
    tcRows: [
        ...
        {
            noTc: '7',
            arrange: 'Admin "admin@gym.test" (fullName: "Admin User") seeded via userService.createAdmin().\nconst data: UpdateAdminInput = { email: "admin@gym.test", fullName: "Admin Renamed" }',
            act: 'updateAdmin(seeded.id, data)',
            expectedReturn: '{ success: true, data: { user: { email: "admin@gym.test", fullName: "Admin Renamed" } } }',
            expectedDbState: 'fullName updated; email unchanged',
            actualResult: 'Passed',
        ...
        {
            noTc: '8',
            arrange: 'Seeded via userService.createAdmin(): adminA (admin-a@gym.test), adminB (admin-b@gym.test).\nFirst call: updateAdmin(adminA.id, { email: "admin-b@gym.test" }) → ConflictError.\nconst data: UpdateAdminInput = { email: "admin-c@gym.test", fullName: "Admin C" }',
            act: 'updateAdmin(adminA.id, data)',
            expectedReturn: '{ success: true, data: { user: { email: "admin-c@gym.test", fullName: "Admin C" } } }',
            expectedDbState: 'adminA row updated to admin-c@gym.test; adminB row unchanged',
            actualResult: 'Passed',
        },
    ],
};
...
const deleteMemberIt: ItDescriptor = {
  ...
  action     -> AppError     [label="catches (not found)", style=dashed];
    ...
    tcRows: [
        ...
        {
            noTc: '4',
            arrange: 'Member seeded via userService.createMember().\nOne workoutSession row inserted via prisma.workoutSession.create({ data: { memberId: seeded.id, date: new Date(), ... } }).\nconst id: string = seeded.id',
            act: 'deleteMember(id)',
            expectedReturn: '{ success: true, data: undefined }',
            expectedDbState: 'Member row, user row, and all cascaded workoutSession rows absent; prisma.workoutSession.count() === 0',
            actualResult: 'Passed',
        },
        {
            noTc: '5',
            arrange: 'One member seeded via userService.createMember().\nFirst call: deleteMember("00000000-0000-0000-0000-000000000000") → NotFoundError.\nconst id: string = seeded.id',
            act: 'deleteMember(id)',
            expectedReturn: '{ success: true, data: undefined }',
            expectedDbState: 'Seeded member row absent; no other rows affected',
            actualResult: 'Passed',
        },
    ],
};
...
const deleteAdminIt: ItDescriptor = {
  ...
  action     -> AppError     [label="catches (not found)", style=dashed];
    ...
    tcRows: [
        ...
        {
            noTc: '4',
            arrange: 'One admin seeded via userService.createAdmin().\nFirst call: deleteAdmin("00000000-0000-0000-0000-000000000000") → NotFoundError.\nconst id: string = seeded.id',
            act: 'deleteAdmin(id)',
            expectedReturn: '{ success: true, data: undefined }',
            expectedDbState: 'Seeded admin row absent; no other rows affected',
            actualResult: 'Passed',
        },
    ],
};
    ...
    tcRows: [
        {
            ...
            act: 'createWorkoutSession(inputData, inputExercises)',
            expectedReturn: '{ success: true, data: { id: defined, memberId: seededMember.id, duration: 60, notes: "Test session", exercises: [length 1] } }',
            expectedDbState: 'One workout_sessions row and one workout_session_exercises row linked to it exist',
            actualResult: 'Passed',
        },
        {
            noTc: '2',
            arrange: 'Member seeded via userService.createMember(). Two exercises seeded via exerciseService.createExercise(): benchPressExercise, deadliftExercise.\nconst inputData: CreateWorkoutSessionInput = { memberId: seededMember.id, date: "2024-06-01", duration: 45 }\nconst inputExercises: WorkoutSessionExerciseInput[] = [{ exerciseId: benchPressExercise.id, sets: 3, reps: 10, weight: 50 }, { exerciseId: deadliftExercise.id, sets: 4, reps: 8, weight: 80 }]',
            act: 'createWorkoutSession(inputData, inputExercises)',
            expectedReturn: '{ success: true, data: { exercises: [length 2, benchPressExercise and deadliftExercise present] } }',
        ...
        },
        {
            ...
            act: 'createWorkoutSession(inputData, inputExercises)',
            expectedReturn: '{ success: false, message: "Validation failed", errors: { memberId: defined, date: defined, duration: defined } }',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        },
        {
        ...
        {
            noTc: '6',
            arrange: 'Member seeded via userService.createMember(). Exercise seeded via exerciseService.createExercise(). Prior call to createWorkoutSession() with memberId "00000000-0000-0000-0000-000000000000" executed and returned { success: false }.\nconst inputData: CreateWorkoutSessionInput = { memberId: seededMember.id, date: "2024-06-01", duration: 60 }\nconst inputExercises: WorkoutSessionExerciseInput[] = [{ exerciseId: seededExercise.id, sets: 3, reps: 10, weight: 50 }]',
            act: 'createWorkoutSession(inputData, inputExercises)',
            expectedReturn: '{ success: true, data: { memberId: seededMember.id } }',
            expectedDbState: 'One workout_sessions row exists for seededMember; no row exists for the non-existent member',
            actualResult: 'Passed',
        },
    ],
};
...
const listMemberWorkoutSessionsIt: ItDescriptor = {
  ...
  transaction -> count       [label="total count"];
    ...
    tcRows: [
        {
            noTc: '1',
            arrange: 'Member seeded via userService.createMember(). Exercise seeded via exerciseService.createExercise(). Three sessions seeded via workoutSessionService.createWorkoutSession(): dates "2024-03-01", "2024-01-01", "2024-06-01".\nconst inputMemberId: string = seededMember.id',
            act: 'listMemberWorkoutSessions(inputMemberId)',
            expectedReturn: '{ success: true, data: { total: 3, items: ordered date ASC [2024-01-01, 2024-03-01, 2024-06-01] } }',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        },
        {
        ...
        {
            noTc: '3',
            arrange: 'Two members seeded via userService.createMember(): member1 (m1@gym.test), member2 (m2@gym.test). Exercise seeded via exerciseService.createExercise(). One session seeded for member1, one session seeded for member2 via workoutSessionService.createWorkoutSession().\nconst inputMemberId: string = member1.id',
            act: 'listMemberWorkoutSessions(inputMemberId)',
            expectedReturn: '{ success: true, data: { total: 1, items: [member1\'s session only] } }',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        },
        {
            ...
            act: 'listMemberWorkoutSessions(inputMemberId, inputOptions)',
        ...
        },
        {
            ...
            act: 'listMemberWorkoutSessions(inputMemberId, inputOptions)',
            expectedReturn: '{ success: true, data: { total: 1, items: [2024-01-01] } }',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        },
        {
            noTc: '6',
            arrange: 'Member seeded via userService.createMember(). Exercise seeded via exerciseService.createExercise(). Three sessions seeded: "2024-01-01", "2024-04-01", "2024-08-01".\nconst inputMemberId: string = seededMember.id\nconst inputOptions: WorkoutSessionListOptions = { startDate: new Date("2024-03-01"), endDate: new Date("2024-06-01") }',
            act: 'listMemberWorkoutSessions(inputMemberId, inputOptions)',
            expectedReturn: '{ success: true, data: { total: 1, items: [2024-04-01] } }',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        },
        {
            noTc: '7',
            arrange: 'Two members seeded via userService.createMember(): member1 (m1@gym.test), member2 (m2@gym.test). Exercise seeded via exerciseService.createExercise(). Sessions seeded: member1 → "2024-01-01", member1 → "2024-06-01", member2 → "2024-06-01".\nconst inputMemberId: string = member1.id\nconst inputOptions: WorkoutSessionListOptions = { startDate: new Date("2024-03-01") }',
            act: 'listMemberWorkoutSessions(inputMemberId, inputOptions)',
            expectedReturn: '{ success: true, data: { total: 1, items: [member1\'s 2024-06-01 session only] } } (member1\'s 2024-01-01 excluded by startDate; member2\'s 2024-06-01 excluded by memberId)',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        },
        {
            noTc: '8',
            arrange: 'Member seeded via userService.createMember(). Exercise seeded via exerciseService.createExercise(). Five sessions seeded: "2024-01-01" through "2024-05-01".\nconst inputMemberId: string = seededMember.id\nconst inputOptions: WorkoutSessionListOptions = { page: 2, pageSize: 2 }',
            act: 'listMemberWorkoutSessions(inputMemberId, inputOptions)',
            expectedReturn: '{ success: true, data: { total: 5, items: [length 2, 2024-03-01, 2024-02-01] (date DESC) } }',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        },
        {
            noTc: '9',
            arrange: 'Member seeded via userService.createMember(). Exercise seeded via exerciseService.createExercise(). Three sessions seeded: "2024-01-01", "2024-02-01", "2024-03-01".\nconst inputMemberId: string = seededMember.id\nconst inputOptions: WorkoutSessionListOptions = { page: 0, pageSize: 2 }',
            act: 'listMemberWorkoutSessions(inputMemberId, inputOptions)',
            expectedReturn: '{ success: true, data: { total: 3, items: [length 2, 2024-03-01, 2024-02-01] } } (page 0 clamped to page 1)',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        },
        {
            ...
            act: 'listMemberWorkoutSessions(inputMemberId, inputOptions)',
            expectedReturn: '{ success: true, data: { total: 3, items: [length 3, first item 2024-03-01] (date DESC) } }',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        },
        {
            ...
            act: 'listMemberWorkoutSessions(inputMemberId, inputOptions)',
            expectedReturn: '{ success: true, data: { total: 3, items: [length 3, 2024-01-01, 2024-02-01, 2024-03-01] } } (pageSize absent → not paginated, date ASC)',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        },
    ],
    ...
    tcRows: [
        {
            ...
            act: 'updateWorkoutSession(inputId, inputData)',
            expectedReturn: '{ success: true, data: { id: seededSession.id, date: 2025-01-15, duration: 90, notes: "Updated" } }',
        ...
        },
        {
            ...
            act: 'updateWorkoutSession(inputId, inputData)',
            expectedReturn: '{ success: true, data: { duration: 90, notes: "Original" } }',
        ...
        },
        {
            ...
            act: 'updateWorkoutSession(inputId, inputData)',
            expectedReturn: '{ success: true, data: { date: 2024-06-01, duration: 60, notes: "Original" } }',
        ...
        },
        {
            ...
            expectedDbState: 'sessionB duration updated to 90; sessionA duration unchanged at 60',
            actualResult: 'Passed',
        },
    ],
};
...
const updateWorkoutSessionWithExercisesIt: ItDescriptor = {
  ...
  action     -> AppError        [label="catches", style=dashed];
    ...
    tcRows: [
        {
            noTc: '1',
            arrange: 'Member seeded via userService.createMember(). Exercise seeded via exerciseService.createExercise(). Session seeded via workoutSessionService.createWorkoutSession() with that exercise (sessionExercise).\nconst inputId: string = seededSession.id\nconst inputData: UpdateWorkoutSessionInput = { duration: 90 }\nconst inputExercises: WorkoutSessionExerciseUpdateInput[] = [{ id: sessionExercise.id, exerciseId: seededExercise.id, sets: 5, reps: 8, weight: 100 }]',
            act: 'updateWorkoutSessionWithExercises(inputId, inputData, inputExercises)',
            expectedReturn: '{ success: true, data: { duration: 90, exercises: [{ id: sessionExercise.id, sets: 5, reps: 8, weight: 100 }] } }',
            expectedDbState: 'workout_sessions duration updated; sessionExercise sets = 5, reps = 8, weight = 100',
            actualResult: 'Passed',
        },
        {
            noTc: '2',
            ...
            act: 'updateWorkoutSessionWithExercises(inputId, {}, inputExercises)',
            expectedReturn: '{ success: false, message: defined non-empty string ("At least one exercise is required") }',
        ...
        {
            noTc: '4',
            arrange: 'Exercise seeded via exerciseService.createExercise(). No session in database.\nconst inputId: string = "00000000-0000-0000-0000-000000000000"\nconst inputExercises: WorkoutSessionExerciseUpdateInput[] = [{ exerciseId: seededExercise.id, sets: 3, reps: 10, weight: 50 }]',
            act: 'updateWorkoutSessionWithExercises(inputId, {}, inputExercises)',
            expectedReturn: '{ success: false, message: defined non-empty string (NotFoundError message) }',
            expectedDbState: 'No change',
            actualResult: 'Passed',
        ...
        {
            noTc: '5',
            arrange: 'Member seeded via userService.createMember(). Two exercises seeded: benchPressExercise, deadliftExercise. Session seeded via workoutSessionService.createWorkoutSession() with both exercises (benchPressEntry, deadliftEntry).\nconst inputId: string = seededSession.id\nconst inputExercises: WorkoutSessionExerciseUpdateInput[] = [{ id: benchPressEntry.id, exerciseId: benchPressExercise.id, sets: 3, reps: 10, weight: 50 }] (deadliftExercise omitted)',
            act: 'updateWorkoutSessionWithExercises(inputId, {}, inputExercises)',
            expectedReturn: '{ success: true, data: { exercises: [length 1, benchPressEntry present] } }',
            expectedDbState: 'deadliftEntry row removed; benchPressEntry row retained',
            actualResult: 'Passed',
        },
        {
            noTc: '6',
            arrange: 'Member seeded via userService.createMember(). Exercise seeded via exerciseService.createExercise(). Session seeded via workoutSessionService.createWorkoutSession() with that exercise (sessionExercise).\nconst inputId: string = seededSession.id\nconst inputExercises: WorkoutSessionExerciseUpdateInput[] = [{ id: sessionExercise.id, exerciseId: seededExercise.id, sets: 5, reps: 8, weight: 100 }]',
            act: 'updateWorkoutSessionWithExercises(inputId, {}, inputExercises)',
            expectedReturn: '{ success: true, data: { exercises: [{ id: sessionExercise.id, sets: 5, reps: 8, weight: 100 }] } }',
            expectedDbState: 'sessionExercise sets = 5, reps = 8, weight = 100',
            actualResult: 'Passed',
        },
        {
            noTc: '7',
            arrange: 'Member seeded via userService.createMember(). Two exercises seeded: benchPressExercise, deadliftExercise. Session seeded via workoutSessionService.createWorkoutSession() with benchPressExercise only (benchPressEntry).\nconst inputId: string = seededSession.id\nconst inputExercises: WorkoutSessionExerciseUpdateInput[] = [{ id: benchPressEntry.id, exerciseId: benchPressExercise.id, sets: 3, reps: 10, weight: 50 }, { exerciseId: deadliftExercise.id, sets: 2, reps: 15, weight: 20 }]',
            act: 'updateWorkoutSessionWithExercises(inputId, {}, inputExercises)',
            expectedReturn: '{ success: true, data: { exercises: [length 2, benchPressEntry present, deadliftExercise new entry present] } }',
            expectedDbState: 'benchPressEntry row retained; new workout_session_exercises row for deadliftExercise created',
            actualResult: 'Passed',
        },
        {
            noTc: '8',
            arrange: 'Member seeded via userService.createMember(). Three exercises seeded: benchPressExercise, deadliftExercise, squatExercise. Session seeded via workoutSessionService.createWorkoutSession() with benchPressExercise and deadliftExercise (benchPressEntry, deadliftEntry).\nconst inputId: string = seededSession.id\nconst inputExercises: WorkoutSessionExerciseUpdateInput[] = [{ id: benchPressEntry.id, exerciseId: benchPressExercise.id, sets: 4, reps: 12, weight: 60 }, { exerciseId: squatExercise.id, sets: 3, reps: 10, weight: 40 }] (deadliftExercise omitted)',
            act: 'updateWorkoutSessionWithExercises(inputId, {}, inputExercises)',
            expectedReturn: '{ success: true, data: { exercises: [length 2, benchPressEntry sets = 4, squatExercise entry present, deadliftEntry absent] } }',
            expectedDbState: 'benchPressEntry sets = 4; deadliftEntry row removed; new row for squatExercise created',
            actualResult: 'Passed',
        },
        {
            noTc: '9',
            arrange: 'Member seeded via userService.createMember(). Exercise seeded via exerciseService.createExercise(). Session seeded via workoutSessionService.createWorkoutSession() with that exercise (sessionExercise). Prior call to updateWorkoutSessionWithExercises() with empty exercises array executed and returned { success: false }.\nconst inputId: string = seededSession.id\nconst inputData: UpdateWorkoutSessionInput = { duration: 90 }\nconst inputExercises: WorkoutSessionExerciseUpdateInput[] = [{ id: sessionExercise.id, exerciseId: seededExercise.id, sets: 3, reps: 10, weight: 50 }]',
            act: 'updateWorkoutSessionWithExercises(inputId, inputData, inputExercises)',
            expectedReturn: '{ success: true, data: { duration: 90 } }',
            expectedDbState: 'workout_sessions duration updated to 90; sessionExercise row unchanged',
            actualResult: 'Passed',
        },
    ],
};
    ...
    tcRows: [
        {
            ...
            act: 'deleteWorkoutSession(inputId)',
            expectedReturn: '{ success: true, data: undefined }',
            expectedDbState: 'workout_sessions row and its linked workout_session_exercises row no longer present',
            actualResult: 'Passed',
        },
        {
            noTc: '2',
        ...
        {
            noTc: '3',
            arrange: 'Member seeded via userService.createMember(). Two exercises seeded: benchPressExercise, deadliftExercise. Session seeded via workoutSessionService.createWorkoutSession() with both exercises.\nconst inputId: string = seededSession.id',
            act: 'deleteWorkoutSession(inputId)',
            expectedReturn: '{ success: true, data: undefined }',
            expectedDbState: 'workout_sessions row and all linked workout_session_exercises rows (both exercise entries) no longer present',
            actualResult: 'Passed',
        },
        {
            noTc: '4',
            arrange: 'Member seeded via userService.createMember(). Exercise seeded via exerciseService.createExercise(). Two sessions seeded: sessionA (date = "2024-01-01"), sessionB (date = "2024-02-01").\nconst inputId: string = sessionA.id',
            act: 'deleteWorkoutSession(inputId)',
            expectedReturn: '{ success: true, data: undefined }',
        ...
        {
            noTc: '5',
            arrange: 'Member seeded via userService.createMember(). Exercise seeded via exerciseService.createExercise(). Two sessions seeded: sessionA (date = "2024-01-01"), sessionB (date = "2024-02-01"). Prior call to deleteWorkoutSession() with id "00000000-0000-0000-0000-000000000000" executed and returned { success: false }.\nconst inputId: string = sessionB.id',
            act: 'deleteWorkoutSession(inputId)',
            expectedReturn: '{ success: true, data: undefined }',
            expectedDbState: 'sessionB and its workout_session_exercises rows removed; sessionA rows still present',
            actualResult: 'Passed',
        },
    ],
};
